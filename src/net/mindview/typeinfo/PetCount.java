...
import net.mindview.typeinfo.pets.Dog;
import net.mindview.typeinfo.pets.ForNameCreator;
import net.mindview.typeinfo.pets.Hamster;
import net.mindview.typeinfo.pets.Manx;
import net.mindview.typeinfo.pets.Mouse;
import net.mindview.typeinfo.pets.Mutt;
import net.mindview.typeinfo.pets.Pet;
import net.mindview.typeinfo.pets.PetCreator;
import net.mindview.typeinfo.pets.Pug;
import net.mindview.typeinfo.pets.Rat;
