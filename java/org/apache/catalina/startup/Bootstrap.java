...
public final class Bootstrap {
    ...
    public void init() throws Exception {
    	...
    	// Created common.loader, server.loader and shared.loader
        initClassLoaders();
        ...
        // The key point of this method is finally to create the instance of Catalina.
   ...
   /**
    ...
    public static void main(String args[]) {
        ...
        if (daemon == null) {
            ...
            // We got catalinaLoader, commonLoader and sharedLoader.
            // These loaders and catalinaDaemon all maintained in the bootstrap reference after initialization above.
            daemon = bootstrap;
        } else {
